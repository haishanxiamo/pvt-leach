...
/*    double netRemainingEnergy = (double)getParentModule()->par("totalRemainingEnergy");
    if(netRemainingEnergy<=thresholdEnergy)
    {
        getParentModule()->par("allNodeDieRound") = getParentModule()->par("roundNumber");
        endSimulation();
    }*/
