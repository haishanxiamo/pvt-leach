...
//        if(roundNo == 2 && i == 49)
//        {
//            EV<<"Node index: " << sortedValue << endl;
//            EV<<"isCH: " << isCH <<endl;
//            endSimulation();
//        }
        ...
        if (isCH == 1) {
            ...
            //if(tempCurNode->distanceToBS >= tempCurNode->Do && tempCurNode->distanceToBS >= 150)
            {
                continue;
            }
            ...
            if (tempCurNode->distanceToBS > tempCurNode->Do) {
                ...
                if (tempCurNode->distanceToBS <= tempCurNode->Do) {
                    ...
                    EV<<"Free space " <<endl;
                             EV<<"Index: " <<sortedValue << "distance to bs" <<tempCurNode->distanceToBS <<endl;
                             //endSimulation();
